...
export function Sidebar({ savedGifCount }: { savedGifCount: number }) {
  const badge = savedGifCount > 0 ? `${savedGifCount}` : undefined
  ...
  return (
    <aside className="hidden w-[245px] shrink-0 border-r border-[#262626] px-3 py-6 lg:flex lg:flex-col">
      ...
      <nav className="flex flex-1 flex-col gap-1">
        ...
        <SidebarItem badge={badge} icon={<MessagesIcon className="h-7 w-7" />} label="Messages" />
