...
import { postMeta } from '../../../mocks/data/socialData'
  ...
  return (
    <article className="relative mb-5 bg-black">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm text-[var(--meta-text)]">
                {post.comments[0]?.createdAt ?? '1h'}
              </span>
            </div>
            {post.location ? (
      ...
      <div className="px-4 pb-3 pt-3">
        ...
        <button className="mb-3 text-sm text-[var(--meta-text)]" type="button">
